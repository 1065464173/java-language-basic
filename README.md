---
typora-root-url: ../../../Library/Application Support/marktext/images

---

# 第一章 编程入门

![image-20210814212441920](https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/image-20210814212441920.png)

* **学习流程**：语言基础—>JVM—>并发多线程

* **职业发展**
  ：<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-15-49-50-image.png" alt="" width="480">

* **学习必备能力**：良好的编码风格—javadoc

* **语言架构认知**：JDK=JRE+开发工具集，JRE=JVM+JavaSE标准类库

  <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-23-24-08-image.png" title="" alt="" width="474">
...
* **语言文件**：
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-15-54-45-image.png" alt="" width="405">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-16-38-18-image.png" alt="" width="483">

## 2.3 数据类型

![](https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-16-38-18-image.png)
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-16-51-25-image.png" alt="" width="298">

![](https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-16-51-25-image.png)
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-16-51-25-image.png" alt="" width="465">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-17-27-56-image.png" alt="" width="392">
...
* <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-22-13-14-image.png" title="" alt="" width="414">
...
* **局部内部类方法调用局部内部类声明的方法中的局部变量，则要求此变量为final，jdk8后可以省略final的声明——开发中常用**
  ...
  <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-23-25-08-image.png" title="" alt="" width="297">

* **内部类的三个问题**

    * 如何实例化成员内部类的对象

      <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-22-44-11-image.png" title="" alt="" width="403">

    * 如何在内部类中区分调用外部类的对象

      <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-22-59-44-image.png" title="" alt="" width="420">

    * 开发中局部内部类的使用（开发中很少见）

      <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-23-24-46-image.png" alt="" width="390">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-09-36-06-image.png" alt="" width="189">
...
- 通过 类 . 静态变量 来调用； 例如Math.PI，System.out
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-10-44-02-image.png" alt="" width="401">
...
* **应用场景**
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-10-52-08-image.png" alt="" width="519">
...
- 线程thread：进程进一步细化为线程，是程序内部的一条执行路径
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-10-53-55-image.png" alt="" width="501">

  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-10-55-56-image.png" alt="" width="502">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-14-23-29-image.png" alt="" width="504">
...
* **java.time** 相当于Calendar包含了所有关于LocalDate，不可变。 LocalTime、LocalDateTime、ZonedDateTime、Duration
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-14-29-00-image.png" alt="" width="383">

* **Instant瞬时** 相当于Date，时间线上的一个瞬时点，用来记录事件时间戳—时间戳是指格林威治时间1970年01月01日00时00分00秒(北京时间1970年01月01日08时00分00秒)起至现在的总秒数。

  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-10-57-08-image.png" alt="" width="408">
...
* **其他API**
  ...
  <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-14-36-30-image.png" title="" alt="" width="517">
...
* **定制排序Comparator**
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-14-43-28-image.png" alt="" width="401">
...
<img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-01-30-image.png" title="" alt="" width="398">
...
<img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-04-54-image.png" title="" alt="" width="474">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-05-28-image.png" alt="" width="364">
...
* 要求：向Set中添加数据，其所在的类一定要重写equals和hashcode方法
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-16-11-42-image.png" alt="" width="477">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-16-06-21-image.png" alt="" width="387">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-16-16-37-image.png" alt="" width="477">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-16-17-31-image.png" alt="" width="445">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-23-25-39-image.png" alt="" width="475">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-28-29-image.png" alt="" width="545">

<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-16-12-18-image.png" alt="" width="353">
...
<img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-14-43-image.png" title="" alt="" width="467">
...
<img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-52-33-image.png" title="" alt="" width="502">
...
* NIO2：jdk1.7
  ...
  <img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-23-04-53-image.png" title="" alt="" width="501">
...
<img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-14-39-01-image.png" alt="" width="475">

**ClassLoader**

<img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-09-36-26-image.png" title="" alt="" width="565">
...
* **在实际开发中，多线程的runnable接口实现的过程也属于代理模式**
  ...
  <img title="" src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-14-15-14-10-image.png" alt="" width="376">

* **使用场合**：调试、远程方法调用

## 12.2 Proxy类

<img src="https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/2021-08-13-15-53-41-image.png" title="" alt="" width="606">
...
![image-20210814220059213](https://cdn.jsdelivr.net/gh/1065464173/markdown-image-rep/image-20210814220059213.png)